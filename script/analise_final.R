...
# ------------------------------------------------------------
# 3. CONHECENDO CADA VARIÁVEL (descritivas e distribuições)
# ------------------------------------------------------------

#  --- Resumo numérico (os "marcos" de cada variável) ---
analise %>%
...
#  --- Distribuição (a forma de cada variável) ---
analise %>%
  select(premio_10, inclinacao, selic, ipca, cambio) %>%
...
#  --- Correlação em NÍVEL (e a armadilha que ela esconde) ---
library(corrplot)
analise %>%
  select(premio_10, inclinacao, selic, ipca, cambio) %>%
  drop_na() %>%
...
#  --- Teste anti-espúrio: nível vs diferenças ---
...
#  --- Dispersão do alvo contra cada variável ---
analise %>%
...
#  --- Por que a curva inverte? Cada vértice vs a Selic ---
...
#  --- O alvo (premio_10) ao longo do tempo ---
...
#  --- A inclinação ao longo do tempo ---
...
#  --- Diagnóstico da série para a modelagem ---
...
#  --- Diferenciando: a variação mês a mês resolve? ---
...
#  --- Ajuste automático na série inteira ---
...
#  --- Validação: separando treino e teste ---
...
#  --- Concorrente manual: ARIMA(1,1,1) ---
...
#  --- Visualização: real vs todas as previsões ---
comp %>%
...
#  --- Diagnóstico dos resíduos (e o teste que importa) ---
# Os 4 gráficos clássicos parecem OK...
...
#  --- A previsão de 2025 (e o veredito) ---
